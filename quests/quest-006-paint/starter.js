/**
 * Drawing App - Starter Code
 *
 * 요구사항:
 * 1. startDrawing() - 마우스 버튼 누르기, 그리기 시작
 * 2. draw() - 마우스 움직임에 따라 그리기
 * 3. stopDrawing() - 마우스 버튼 떼기, 그리기 종료
 * 4. clearCanvas() - 캔버스 전체 지우기
 * 5. undoDrawing() - 마지막 획 되돌리기
 */
